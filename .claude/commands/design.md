...
- `context/tech-stack.md` + `context/constraints.md`

Output: `.claude/memory/architecture/system-design.yaml`.
...
- **PASS** → `auditor` writes `.claude/memory/architecture/design_review.md` with verdict PASS.
...
- `.claude/memory/architecture/design_review.md`
