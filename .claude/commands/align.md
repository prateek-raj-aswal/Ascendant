...
`clarify` writes `.claude/memory/requirements.md` with:
...
Collect answers. Update `.claude/memory/requirements.md`.
**Do not proceed until the user explicitly confirms all questions are resolved.**

After resolution, the verdict in requirements.md should be ALIGNED.

---

## Success Criteria
- [ ] `.claude/memory/requirements.md` exists
- [ ] Verdict: ALIGNED
